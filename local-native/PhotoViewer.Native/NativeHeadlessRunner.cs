...
internal static class NativeHeadlessRunner
{
    ...
    public static int RunPvuStateMigrationSmoke()
    {
        ...
        var browserFavoriteImage = Path.Combine(browserRecentA, "favorite-browser.png");
        ...
        var payload = new
        {
            localStorage = new Dictionary<string, object>
            {
                ...
                ["pvu_scroll_memory"] = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
                {
                    ["browser:created-newest:fixture"] = 42,
                },
                ["pvu_fav_levels"] = new[] { 3, 5 },
                ["pvu_favorites"] = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
                {
                    [browserFavoriteImage] = 5,
                },
                ["pvu_favorites_backup"] = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
                {
                    [browserFavoriteImage] = 5,
                },
        ...
        var browserMirrorStored = browserPvuViewMirror.Contains("viewMode", StringComparison.OrdinalIgnoreCase) &&
            ...
            browserPvuViewMirror.Contains("aspectMode", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("displayStyle", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("columns", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("sortBy", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("randomSeed", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("sidebarOpen", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("modalEdgeRatio", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("enhanceQueueOpen", StringComparison.OrdinalIgnoreCase) &&
        ...
        var displayDetailsMirrorStored = browserPvuViewMirror.Contains("aspectMode", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("displayStyle", StringComparison.OrdinalIgnoreCase) &&
            browserPvuViewMirror.Contains("columns", StringComparison.OrdinalIgnoreCase);
        var modalEdgeRatioMirrorStored = browserPvuViewMirror.Contains("modalEdgeRatio", StringComparison.OrdinalIgnoreCase);
        var enhanceQueueOpenMirrorStored = browserPvuViewMirror.Contains("enhanceQueueOpen", StringComparison.OrdinalIgnoreCase);
        ...
        var scrollMemoryMirrorStored = store.GetSetting("browser_pvu_scroll_memory", "").Contains("browser:created-newest:fixture", StringComparison.OrdinalIgnoreCase);
        var favLevelsMirrorStored = store.GetSetting("browser_pvu_fav_levels", "").Contains("3", StringComparison.OrdinalIgnoreCase);
        var favoriteStorageMirrorStored = store.GetSetting("browser_pvu_favorites", "").Contains("favorite-browser.png", StringComparison.OrdinalIgnoreCase) &&
            store.GetSetting("browser_pvu_favorites", "").Contains("5", StringComparison.OrdinalIgnoreCase);
        var favoriteBackupMirrorStored = store.GetSetting("browser_pvu_favorites_backup", "").Contains("favorite-browser.png", StringComparison.OrdinalIgnoreCase) &&
            store.GetSetting("browser_pvu_favorites_backup", "").Contains("5", StringComparison.OrdinalIgnoreCase);
        ...
        var pvuLocalStorageFavoritesDeferred =
            favoriteStorageMirrorStored &&
            favoriteBackupMirrorStored &&
            firstImport.FavoriteCount == 0 &&
            store.LoadFavorites().Count == 0 &&
            !migrations.Contains("pvu_favorites", StringComparison.OrdinalIgnoreCase) &&
            !migrations.Contains("pvu_favorites_backup", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("pvu_favorites", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("favorites", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("favorites_backup", ""));
        ...
        var pvuPinnedTabsDeferred =
            pinnedTabsMirrorStored &&
            !migrations.Contains("pvu_pinned_tabs", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("pinned_tabs", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("pinned_preview_tabs", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("preview_tabs", ""));
        var pvuRecentAlbumsDeferred =
            recentAlbumsMirrorStored &&
            !migrations.Contains("pvu_recent_albums", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("recent_albums", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("recent_album", "")) &&
        ...
        var nativeKeyBindingsJson = "{\"next\":\"Shift+Right\",\"previous\":\"Left\",\"favoriteUp\":\"Ctrl+Up\",\"favoriteDown\":\"Ctrl+Down\",\"delete\":\"Delete\",\"openFile\":\"Enter\",\"openFolder\":\"Ctrl+Enter\",\"openDetail\":\"Ctrl+M\",\"toggleView\":\"Ctrl+G\",\"togglePreview\":\"Ctrl+P\",\"toggleDetails\":\"Ctrl+D\",\"reshuffleSort\":\"Ctrl+R\"}";
        store.SaveSetting("keybindings_json", nativeKeyBindingsJson);
        ...
        var nativeKeyBindingsPreserved = string.Equals(store.GetSetting("keybindings_json", ""), nativeKeyBindingsJson, StringComparison.OrdinalIgnoreCase);
        ...
        var pvuSortDirectionSeedDeferred =
            browserPvuViewMirror.Contains("randomSeed", StringComparison.OrdinalIgnoreCase) &&
            unsupportedSortModeWarning &&
            !migrations.Contains("randomSeed", StringComparison.OrdinalIgnoreCase) &&
            !migrations.Contains("sort_direction", StringComparison.OrdinalIgnoreCase) &&
            !migrations.Contains("sort_seed", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("sort_direction", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("sort_ascending", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("random_seed", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("randomSeed", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("sort_seed", ""));
        var pvuSidebarOpenDeferred =
            browserPvuViewMirror.Contains("sidebarOpen", StringComparison.OrdinalIgnoreCase) &&
            !migrations.Contains("pvu_view.sidebarOpen", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("sidebar_open", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("sidebar_visible", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("left_sidebar_open", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("left_panel_visible", ""));
        var pvuModalEdgeRatioDeferred =
            modalEdgeRatioMirrorStored &&
            !migrations.Contains("pvu_view.modalEdgeRatio", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("modal_edge_ratio", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("modalEdgeRatio", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("detail_modal_edge_ratio", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("modal_edge_zone_ratio", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("modal_click_edge_ratio", ""));
        var pvuEnhanceQueueOpenDeferred =
            enhanceQueueOpenMirrorStored &&
            !migrations.Contains("pvu_view.enhanceQueueOpen", StringComparison.OrdinalIgnoreCase) &&
            string.IsNullOrWhiteSpace(store.GetSetting("enhance_queue_open", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("enhanceQueueOpen", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("enhancement_queue_open", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("enhancement_queue_visible", "")) &&
            string.IsNullOrWhiteSpace(store.GetSetting("enhancement_queue_panel_open", ""));
        ...
        var nativeKeyBindingsStillPreserved = string.Equals(store.GetSetting("keybindings_json", ""), nativeKeyBindingsJson, StringComparison.OrdinalIgnoreCase);
        ...
        var passed = pvuViewModeMigrated &&
            ...
            pvuLocalStorageFavoritesDeferred &&
            pvuSortDirectionSeedDeferred &&
            pvuSidebarOpenDeferred &&
            pvuModalEdgeRatioDeferred &&
            pvuEnhanceQueueOpenDeferred &&
            ...
            nativeKeyBindingsStillPreserved &&
