...
- GitHub milestone #26 `Local Native Post-v1 Backlog`: open, 20 open / 2
  closed after final refresh.
- Closed in milestone #26: #115, #116.
- Open in milestone #26: #97-#114, #117, and #118.
- Open PRs: none.
...
- During this lane, #117 PR #123 merged at
  ...
  but #117 remained open for the next bounded row.
- This triage report first landed through PR #124 at
  `b8a60e36bfc511a999ec3b131902ef8dbbdc42db`; PR CI #28920359011 passed.
- SQLite: job #236 was updated to `merged` for PR #123. A later #117 row is
  already represented by job #237, status `dispatched`, and should not be
  competed with from this triage lane.
...
| #117 Complete pvu state persistence migration | Open | Reserved / serialized | Parent/another lane owns the next bounded row via SQLite job #237. Do not compete unless that lane explicitly hands it back. |
...
- `ADOPT`: Treat #117 as externally owned and reserved for job #237; do not
  parallelize implementation from this triage lane.
