...
20,000件の最終観測値（このmachine/fixtureの証拠であり製品hard閾値ではない）: fixture 6,102ms、load 9,765ms、final rapid search 361ms、Grid 96/maximum 384、List 19、heartbeat 16、working set 139,468,800→267,333,632 bytes、GC gen0/1/2 = 22/14/3。source 20,000維持、truncate 0、Enhancement 0。初回観測はfixture 5,953ms、load 8,180ms、search 332ms、working set 147,943,424→370,585,600 bytes、GC 25/16/6だった。
