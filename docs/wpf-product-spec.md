...
Browser基準のWPF P0/P1は実装・専用smoke済み。日常利用のP2は、Bulk Favorite、Bulk Recycle、right panel resize、preview tab reload/hover/reorder/middle-close、modal end wrap/chrome/edge/swipe/feedback、Prompt tag→search、Folder bucket range selection/selected actions/collapse persistence、native Explorer FileDrop drag-outまでfocused verifier付きで実装済み。
