...
| P0D 統合gate | **DONE** | 5,000件、malformed state/shared JSON、lock recovery、Favorite/Seen merge、zoom/Delete、passive enhancement isolation。`verify-wpf-p0.ps1` |
...
| Preview tabs | **DONE** | open/activate/pin/hover/close/reopen/close-all、最大30、drag/Alt+Shift reorder、middle-close、order/active reload restore、focus/Automation。`verify-wpf-preview-tabs.ps1`, `verify-wpf-preview-tab-reorder.ps1` |
...
| P2 remaining | **OPEN** | prompt tag→search、native drag-out。 |
