...
このledgerはverified implementation commit `af2bc71`のlive code、42-check aggregate、cross-runtime verifierを照合した状態。後続変更では該当row、正規仕様、focused verifierを同じchangeで更新する。
