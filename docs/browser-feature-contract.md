...
現行BrowserはGallery primary button/group、folder controls、Search combobox/chips、preview tabs、dialog、resize separatorへkeyboard/semantic contractを実装済み。Search chipはmouse/touch/pen/keyboardで同じreorder/remove結果へ到達できる。
