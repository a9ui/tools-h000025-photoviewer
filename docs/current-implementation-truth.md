...
実装正本commit: `53dc865c08e5009b511e39f0f23405e15730b3db`。このmachineの
...
| --- | --- | --- |
| `GIT-LOCAL-001` | commit | 通常rootの実装revisionは `53dc865c08e5009b511e39f0f23405e15730b3db`。`refs/heads/main` はそのdocs-only descendantで、実装baselineのparentは監査開始時の `901c223...` |
| `GIT-REMOTE-001` | provenance | default `origin/main=626b7dd5416f3619ae59fc66d47e79acd1a74fd5` は古いまま。実装revision `53dc865...` は `origin/codex/wpf-thumbnail-performance-20260719` へpush済みで、Draft PR [#322](https://github.com/a9ui/tools-h000025-photoviewer/pull/322) がdefault mainとの差分を保持する。mergeまではorigin/mainを正本にしない |
...
| `KNOWN-GIT-001` | repo | default origin/mainはlocal mainより古い | `53dc865...`はremote branchとDraft PR #322へ退避済み。PR mergeまでは新規作業を古いorigin/mainから開始しない。deploymentなし |
