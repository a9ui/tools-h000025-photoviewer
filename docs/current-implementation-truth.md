...
| `GIT-REMOTE-001` | provenance | default `origin/main=626b7dd5416f3619ae59fc66d47e79acd1a74fd5` は古いまま。Draft PR [#322](https://github.com/a9ui/tools-h000025-photoviewer/pull/322) がlocal mainとの差分を保持する。mergeまではorigin/mainを正本にしない |
...
| `KNOWN-GIT-001` | repo | default origin/mainはlocal mainより古い | local mainはDraft PR #322のbranchへ退避する。PR mergeまでは新規作業を古いorigin/mainから開始しない。deploymentなし |
