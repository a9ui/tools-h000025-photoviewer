...
import {
  DEFAULT_ENHANCEMENT_SETTINGS as DEFAULT_ENHANCEMENT_SETTINGS_SOURCE,
  ENHANCEMENT_PRESETS,
...
export const BUILTIN_ENHANCEMENT_PRESETS: EnhancementPreset[] = ENHANCEMENT_PRESETS;
export const DEFAULT_ENHANCEMENT_SETTINGS: EnhancementSettings = DEFAULT_ENHANCEMENT_SETTINGS_SOURCE;
